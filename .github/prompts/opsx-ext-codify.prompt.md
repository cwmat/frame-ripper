...
Invoke the `openspec-ext-codify-from-code` skill at `.github/skills/openspec-ext-codify-from-code/SKILL.md` and follow its workflow exactly. Pay particular attention to the **clean working tree** preflight — abort if `git status` is dirty.
