...
Invoke the `openspec-ext-port-spec` skill at `.github/skills/openspec-ext-port-spec/SKILL.md` and follow its workflow exactly. Pause before silently dropping or auto-adapting any requirement that names foreign tech absent from this repo.
