...
2. Read this repo's stack signals (these inform the rewrite):
   ...
   - `CLAUDE.md` / `AGENTS.md` / `.github/copilot-instructions.md` — architecture conventions, persistence model, file layout
...
4. **Write `proposal.md`** following the official template:
   ...
   - **Impact**: file paths in *this* repo, this repo's storage/state, this repo's tests
