...
#### Scenario: at-cursor mode uses input-side seek

- **WHEN** `buildExtractionArgs` is called with `mode='at-cursor'` and `cursorTime=5.5`, `nearbyFrames=0`
...
- Three modes — `src/utils/ffmpegCommands.ts:32-67`, `tests/utils/ffmpegCommands.test.ts:22-70`
- JPG quality mapping — `src/utils/ffmpegCommands.ts:7-10,61-63`, `tests/utils/ffmpegCommands.test.ts:72-101`
- at-cursor seek window — `src/utils/ffmpegCommands.ts:39-47`, `tests/utils/ffmpegCommands.test.ts:103-158`
- Output filename pattern — `src/utils/ffmpegCommands.ts:12-14`, `tests/utils/ffmpegCommands.test.ts:9-17`
- Frame placement — `src/utils/ffmpegCommands.ts:16-30`, `tests/utils/ffmpegCommands.test.ts:181-238`
